  ...
  return (
    <div>
      ...
      <dialog ref={dialogRef}>
        ...
        <div class="container mx-auto px-4 py-2 bg-panel shadow-lg border-gray-700">
...
{/*
          <Form style={{color : 'white'}} onSubmit={handleSubmit}>
            <Row>
                ...
                <Col>
                  <Button style={{marginTop: '33px'}} id="AccountBookDialogPayBtn"  class="text-secondary hover:text-white text-sm font-medium px-3 py-1 rounded hover:bg-gray-700 transition-colors border border-secondary" formAction="submitBook" type='submit' >
                    <Plus/>
                  </Button>
                </Col>
              </Row>
